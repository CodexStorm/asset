...
public class Constants {
    ...
    public static final int FACILIIY_ASSET_TYPE = 3002;
    public static final int PROFILE_ASSET_TYPE = 3001;
    public static final int TRANSFER_ISSUE_ID = 1;

    public static final String ASSET_LIST_URL="http://192.168.43.32:1111/api/web/find/asset?userId=";
    public static final String ASSET_DETAILS_MODEL_URL="http://192.168.43.32:1111/api/web/details/asset?assetId=";
    public static final String ASSET_USER_RECIEVAL_MODEL_URL="http://192.168.43.32:1111/api/web/request/assignedAssets?assetRequestId=";
    ...
    public static final String PENDING_REQUESTS_URL="http://192.168.43.32:1111/api/web/request/pending?userId=";
    public static final String PENDING_REQUESTS_DETAILS_MODEL_URL="http://192.168.43.32:1111/api/web/request?assetRequestId=";
    public static String PENDING_REQUESTS_DETAILS_URL;
    public static final String ASSET_ACCEPT_URL="http://192.168.43.32:1111/api/web/request/accept";

    public static final String INITIATE_TRANSFER_URL="http://192.168.43.32:1111/api/web/request/transfer";
    public static final String ASSET_REQUEST_URL="http://192.168.43.32:1111/api/web/request/newAsset";
    public static final String TRANSFER_REASONS_API="http://192.168.43.32:1111/api/web/find/transferReason";
    public static final String ASSET_TYPE_API="http://192.168.43.32:1111/api/web/find/asset/type";
    public static final String GET_LABOUR_FOR_ATTENDANCE_URL="http://192.168.43.32:1111/api/web/labour/attendance";
    public static final String MARK_ATTENDANCE_URL="http://192.168.43.32:1111/api/web/labourAttendanceTracker";
    public static final String GET_LABOUR_SHIFT_DETAILS_URL="http://192.168.43.32:1111/api/web/labourAttendanceTracker/facilityShiftDetails";
    public static final String GET_REPORTED_LABOUR_URL="http://192.168.43.32:1111/api/web/labourAttendanceTracker/reportedLabour?shiftDetailId=";
    public static final String REVOKE_ATTENDANCE_URL="http://192.168.43.32:1111/api/web/labourAttendanceTracker/revokeAttendance";
    public static final String GET_PENALTIES_URL="http://192.168.43.32:1111/api/web/penalties/get";
    public static final String GET_LABOUR_TIME_ABSOLUTE_URL="http://192.168.43.32:1111/api/web/labour/shiftHours";
