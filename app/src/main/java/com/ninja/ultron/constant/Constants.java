...
public class Constants {
    ...
    public static final String ASSET_REQUEST_URL="http://10.1.19.141:1111/api/web/request/newAsset";
    public static final String TRANSFER_REASONS_API="http://10.1.19.141:1111/api/web/find/transferReason";
